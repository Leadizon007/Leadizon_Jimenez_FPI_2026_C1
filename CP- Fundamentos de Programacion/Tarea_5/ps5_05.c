...
int main() {
    ...
    int VEC[100];               // arreglo unidimensional ordenado
    ...
    int posicion;               // posición donde se inserta o elimina
    
    // ========== ENTRADA INICIAL DE DATOS ==========
    printf("================================================\n");
    printf("INSERTAR Y ELIMINAR EN ARREGLO ORDENADO (PS5.5)\n");
    printf("================================================\n\n");
    ...
    printf("\nIngrese los %d elementos en orden CRECIENTE:\n", N);
    for (i = 0; i < N; i++) {
    ...
    while (1) {
        ...
        switch (opcion) {
            case 1:
                // ========== MOSTRAR ARREGLO ==========
                printf("\n================================================\n");
                printf("ARREGLO ACTUAL (ORDENADO EN FORMA CRECIENTE)\n");
                printf("================================================\n\n");
            ...
            case 2:
                ...
                if (encontrado) {
                    ...
                    printf("Posicion de insercion: %d\n", posicion + 1);
            ...
            case 3:
                ...
                if (!encontrado) {
                    ...
                    // Eliminar el elemento desplazando los siguientes hacia la izquierda
                    ...
                    printf("Posicion de eliminacion: %d\n", posicion + 1);
                    printf("Nuevo tamano del arreglo: %d elementos\n", N);
                }
                break;
